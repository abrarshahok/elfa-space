...
class LocalFoodShops extends StatelessWidget {
  static const routeName = '/local-food-shops';
  const LocalFoodShops({super.key});

  final topShopsList = const [
    {
      'title': "Burger Bar",
      'image': MyImages.localFood1,
      'address': 'Latifabad No 10, Hyderabad',
    },
    {
      'title': "Munch Time",
      'image': MyImages.localFood2,
      'address': 'Latifabad No 10, Hyderabad',
    },
  ];
