...
class MeatShops extends StatelessWidget {
  static const routeName = '/meat-shops';
  const MeatShops({super.key});

  final topShopsList = const [
    {
      'title': "Meat Bar",
      'image': MyImages.meat1,
      'address': 'Latifabad No 10, Hyderabad',
    },
    {
      'title': "Meat Time",
      'image': MyImages.meat2,
      'address': 'Latifabad No 10, Hyderabad',
    },
  ];
