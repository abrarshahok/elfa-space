...
class ChickenShops extends StatelessWidget {
  static const routeName = '/chicken-shops';
  const ChickenShops({super.key});

  final topShopsList = const [
    {
      'title': "Cluck 'n' Crisp",
      'image': MyImages.shop1,
      'address': 'Latifabad No 10, Hyderabad',
    },
    {
      'title': "Chicken Coop",
      'image': MyImages.shop2,
      'address': 'Latifabad No 10, Hyderabad',
    },
  ];
  ...
  final allShopsList = const [
    ...
    {
      'title': "Chicken Coop",
      'image': MyImages.shop4,
      'address': 'Latifabad No 10, Hyderabad',
    },
    {
      'title': "Mad Chicken",
      'image': MyImages.shop6,
      'address': 'Latifabad No 10, Hyderabad',
    },
  ];
                        ...
                        onPressed: () {
                          Navigator.of(context).pushNamed(
                            ...
                            arguments: {
                              ...
                              'title': 'Top Chicken Shops',
                              'itemInfo': {
                                'title': 'Chicken',
                                'image': MyImages.chicken,
                                'price': 0.0,
                              },
                            },
                          );
